...
import { navRightLinks } from "@/constants";
    ...
    <section className="max-w-[264px]">
      <Sheet>
        <SheetTrigger asChild>
            <DotsHorizontalIcon className="h-6 w-6 ml-2 cursor-pointer sm:hidden" />
        </SheetTrigger>
        <SheetContent side="top" className="border-none bg-gray-200">
