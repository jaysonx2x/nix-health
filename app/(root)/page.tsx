...
const pieData = [
  ...
  { browser: "Admitted", visitors: 200, fill: "var(--color-safari)" },
  { browser: "Discharged", visitors: 287, fill: "var(--color-firefox)" },
];
    ...
    <section className="min-h-screen">
      ...
      <>
        ...
        <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-2 mt-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-gray-700">Bar Chart - Multiple</CardTitle>
          ...
          <Card>
            <CardHeader className="pb-0">
              <CardTitle className="text-gray-700 ">Pie Chart - Donut with Text</CardTitle>
              <CardDescription>January - June 2024</CardDescription>
            </CardHeader>
